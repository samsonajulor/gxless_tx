...
// src/auth-adapter.ts
import { intToHex, isNullish, addHexPrefix } from "@particle-network/auth";
  ...
  request(request) {
    return __async(this, null, function* () {
      if (request.method === "eth_requestAccounts" || request.method === "eth_accounts") {
        ...
        return intToHex(this.auth.chainId());
        ...
        if (request.params && request.params instanceof Array && request.params[0]) {
          ...
          if (isNullish(txData.type)) {
            if (chains.isChainSupportEIP1559(this.auth.chain())) {
              txData.type = "0x2";
            } else {
              txData.type = "0x0";
            }
          ...
          if (isNullish(txData.chainId)) {
            txData.chainId = intToHex(this.auth.chainId());
          }
...
var ParticleProvider = class extends IJsonRpcProvider {
  ...
  open() {
    return __async(this, null, function* () {
      ...
      this.emit("connect", {
        chainId: intToHex2(this.auth.chainId())
      });
    });
  }
  close() {
