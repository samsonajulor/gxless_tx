...
import { chains as chains2 } from "@particle-network/common";
...
// src/utils/tron/crypto.ts
var sha256 = (msg) => crypto.createHash("sha256").update(Buffer.from(msg, "hex")).digest("hex");
...
var _WalletEntryPlugin = class {
  ...
  openWallet() {
    ...
    if ((iframe == null ? void 0 : iframe.src) && qs.parse(iframe == null ? void 0 : iframe.src.split("?").pop()).theme !== uiMode) {
      iframe.remove();
      iframe = null;
    }
    if (!iframe) {
